...
def collect_waiting_1():
    ...
    gyro_turn.single_motor_turn(-103, 0, 1)
    gyro_turn.single_motor_turn(0, 1, 0)

    intake.open()

    base.reset_angle()
    gyro_straight.move(-1400, 2, lambda: base.angle() > -600, True)
...
def end():
    gyro_turn.turn(-47)
    base.reset_angle()
    gyro_straight.move(-1400, -48, lambda: base.angle() > -1100)
